...
Fastify owns transport concerns while feature folders own their corresponding integration or rendering logic. This avoids coupling the MCP protocol to persistence and presentation details.
