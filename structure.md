...
```text
.
|-- .agents/              Confirmed project decisions
|-- src/
|   |-- auth/             Marketplace identity boundary
...
|-- implementation.md      Approved implementation plan
`-- README.md              Project overview
```

To find project decisions visit [.agents/README.md](file:///C:/Hackathons/Slide%20Maker/.agents/README.md).
To find service architecture visit [src/README.md](file:///C:/Hackathons/Slide%20Maker/src/README.md).
To find marketplace identity handling visit [src/auth/README.md](file:///C:/Hackathons/Slide%20Maker/src/auth/README.md).
